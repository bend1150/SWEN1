...
class BattleLogicTest {
    ...
    */
    ...
    void monsterBattle() {
        ...
        Card card1 = new MonsterCard("Goblin", "WATER", 10,1);
        Card card2 = new MonsterCard("Troll", "FIRE", 15,2);
    ...
    void mixedBattle() {
        ...
        Card card1 = new MonsterCard("GOBLIN", "WATER", 10,1);
        Card card2 = new SpellCard("WATER", 15, 2);

        Card card3 = new MonsterCard("KRAKEN", "NORMAL", 20,3);
        Card card4 = new SpellCard("FIRE",45,4);

        assertEquals(2, BattleLogic.MixedBattle(card1,card2));  //Player2 should win
        assertEquals(1, BattleLogic.MixedBattle(card2,card1));  //Player1 should win
